...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) //эта аннотация задает порядок выполнения тестов
...
/*    @BeforeEach //что-то неправильно тут написано
    ...
    @Order(1)
    //@RepeatedTest(50) //аннотация, чтобы этот тест прогнался 50 раз
    @Test
    public void testAscendingSequenceHappyPathPositiveNumber() { //Сначала пишем хэппи-тест – такой, что мы даем верные
        // параметры
        // и получаем ожидаемый результат
        //triple A pattern
        //0, 1, 2, 3, 4, 5 //устанавливаем значения
        int start = 0;
        int end = 5;
        int step = 1;
